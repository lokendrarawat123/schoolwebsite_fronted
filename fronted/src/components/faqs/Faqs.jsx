...
const Faqs = () => {
  ...
  if (error)
    return (
      <div className="text-center py-6 sm:py-8 md:py-10 text-red-500 text-sm sm:text-base">Error fetching FAQs!</div>
    );
  if (!faqData?.data || faqData.data.length === 0)
    return (
      <div className="text-center py-6 sm:py-8 md:py-10 text-gray-400 text-sm sm:text-base">No FAQs available.</div>
    );
