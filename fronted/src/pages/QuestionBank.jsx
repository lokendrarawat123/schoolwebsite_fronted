    ...
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-12 relative max-w-md mx-auto">
          <input
            type="text"
            placeholder="Search question papers by title..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full border border-gray-300 rounded-full px-5 py-3 pr-12 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition placeholder-gray-400"
          />
        ...
        {!isLoading && !error && filteredPapers.length > 0 && (
          <div className="space-y-4">
            {filteredPapers.map((paper) => (
              <div
                key={paper.id}
                className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-100 p-6"
              >
